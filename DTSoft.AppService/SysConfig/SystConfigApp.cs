...
public class SysConfigApp(SysDbContext dbContext, ConfigHelper configHelper, AttachmentApp att, IDtSoftCache dtSoftCache)
{
    ...
    private void AddInitialData()
    {
        ...
        menuList.AddRange([userManagement, userList, attachmentManagement, attachmentList, roleManagement, roleList, adminPanel, systemManagement, menuManagement, systemIntegration, apiKeyManagement, systemSettingsPage, systemLog, appConfig, menuMaintenance]);
